  ...
  return {
    cssVars: {
      root: {
        ...
        "--surface-1": brandTint(baseHue, 5, 98),
        "--surface-2": brandTint(baseHue, 4, 96),
        "--surface-3": brandTint(baseHue, 5, 91),
        "--surface-4": brandTint(baseHue, 6, 86),
        "--surface-5": shade(B, 50),
        "--surface-6": shade(A, 50),
        "--surface-7": shade(S, 50),
        "--surface-8": shade(W, 50),
        "--surface-9": shade(D, 50),
      ...
      dark: {
        ...
        "--surface-1": brandTint(baseHue, 12, 8),
        "--surface-2": brandTint(baseHue, 11, 11),
        "--surface-3": brandTint(baseHue, 10, 15),
        "--surface-4": brandTint(baseHue, 10, 19),
        "--surface-5": shade(B, 950),
        "--surface-6": shade(A, 950),
